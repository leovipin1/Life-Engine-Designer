...
26. **`Back end sheets layout and process`** &larr; ***You are viewing this document***

27. **[Back end access layout and process](backend-access.md)**

</details>

# Back end sheets layout and process

This document provides the details about the layout and processes of the dashboard, db, schema code, incomplete records and formula sheets.