...
15. **`Delete table layout and process`** &larr; ***You are viewing this document***
...
# Delete table layout and process

This document provides the details about the layout and processes that must be excecuted when a table is to be deleted.