...
7. **`Design initiation layout and process`** &larr; ***You are viewing this document***
...
# Design initiation layout and process

This document provides the details about the layout and processes that must be excecuted when the design is initiated.