...
21. **`View table record layout and process`** &larr; ***You are viewing this document***
...
# View table record layout and process

This document provides the details about the layout and processes that must be excecuted when a table record is to be viewed.