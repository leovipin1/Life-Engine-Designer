...
12. **`Design message layout and process`** &larr; ***You are viewing this document***
...
# Design message layout and process

This document provides the details about the layout and processes that must be excecuted when a design message is shown.