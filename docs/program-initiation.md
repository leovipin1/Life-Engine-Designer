...
4. **`Program initiation layout and process`** &larr; ***You are viewing this document***
...
# Program initiation layout and process

This document provides the details about the layout and processes that must be excecuted when the program is initiated.