...
25. **`Back end tables layout and process`** &larr; ***You are viewing this document***
...
# Back end tables layout and process

This document provides the details about the layout and processes of the dashboard, db, schema code and incomplete records tables.