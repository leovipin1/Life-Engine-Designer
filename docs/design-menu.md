...
11. **`Design menu layout and process`** &larr; ***You are viewing this document***
...
# Design menu layout and process

This document provides the details about the layout and processes that must be excecuted when the design's menu is accessed.