...
8. **`Design termination layout and end process`** &larr; ***You are viewing this document***
...
# Design termination layout and process

This document provides the details about the layout and the processes that must be excecuted when the design is terminated.