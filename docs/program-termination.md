...
5. **`Program termination layout and process`** &larr; ***You are viewing this document***
...
# Program termination layout and process

This document provides the details about the layout and processes that must be excecuted when the program is terminated.